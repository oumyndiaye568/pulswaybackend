...
import medecinRoutes from './modules/medecin/MedecinRoute'
import sseRoutes from './modules/sse/SSERoute'
import accueilRoutes from './modules/accueil/AccueilRoute'
